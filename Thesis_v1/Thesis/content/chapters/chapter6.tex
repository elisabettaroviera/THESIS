...
field-cancerisation signal is either attenuated or partially confounded by
...
attenuation of the field-cancerisation signal rather than a failure of the
...
its intermediate position along the field-cancerisation signal axis.
...
of the joint variance structure~\cite{Sokolov2024}.
...
framework~\cite{fortin2018neurocombat} provides a principled
