...
\subsubsection*{Intrinsic separability of the 5,000-CpG panel}
...
\begin{subfigure}[b]{0.48\textwidth}
  \includegraphics[width=\textwidth]
    {images/cap6/GSE69914_knn_boundary}
  \caption{KNN decision boundary — 5,000 CpGs,
           PCA projection.}
\end{subfigure}
\hfill
\begin{subfigure}[b]{0.48\textwidth}
  \includegraphics[width=\textwidth]
    {images/cap6/GSE69914_knncheck_proba_dist_50cpg}
  \caption{Probability score distribution —
           50-CpG compressed model.}
\end{subfigure}
\caption{GSE69914: KNN decision geometry and
         compressed-model score distributions.}
\label{fig:gse69914_knn}
\end{figure}

\subsubsection*{Separation along the Tumor axis}
...
\subsubsection*{Compression to 50 CpGs}
...
\begin{subfigure}[b]{0.48\textwidth}
  \includegraphics[width=\textwidth]
    {images/cap6/GSE69914_volcano_50cpg}
  \caption{Volcano plot: SVM coefficient magnitude
           vs.\ $\Delta M$ effect size.}
\end{subfigure}
\hfill
\begin{subfigure}[b]{0.48\textwidth}
  \includegraphics[width=\textwidth]
    {images/cap6/GSE69914_knapsack_selected_contributions_stacked}
  \caption{Stacked objective contributions for the
           50 selected CpGs.}
\end{subfigure}
\caption{GSE69914: compressed panel diagnostics —
         discriminative weight versus effect size (left)
         and score decomposition by component (right).}
\label{fig:gse69914_compression}
\end{figure}

\subsubsection*{Cross-dataset transferability}
...
\subsubsection*{Gene-level coherence and functional enrichment}
...
\subsubsection*{Linear separability of the 5,000-CpG panel}
...
\includegraphics[width=0.6\textwidth]
  {images/cap6/GSE225845_boundary_pca_prob_calibrated}
\caption{GSE225845: calibrated SVM decision boundary projected
...
\centering
\begin{subfigure}[b]{0.48\textwidth}
  \includegraphics[width=\textwidth]{images/cap6/GSE225845_ScoreDist}
  \caption{Score distribution — 5,000 CpGs.}
\end{subfigure}
\hfill
\begin{subfigure}[b]{0.48\textwidth}
  \includegraphics[width=\textwidth]
    {images/cap6/GSE225845_svmcheck_score_dist_50cpg}
  \caption{Score distribution — 50-CpG compressed model.}
\end{subfigure}
\caption{GSE225845: SVM decision score distributions for the
         full and compressed panels.}
\label{fig:gse225845_scores}
\end{figure}

\subsubsection*{Cross-dataset transferability of the
5,000-CpG panel}
...
\begin{subfigure}[b]{0.48\textwidth}
  \includegraphics[width=\textwidth]
    {images/cap6/GSE225845_volcano_50cpg}
  \caption{Volcano plot: SVM coefficient magnitude
           vs.\ $\Delta M$ effect size.}
\end{subfigure}
\hfill
\begin{subfigure}[b]{0.48\textwidth}
  \includegraphics[width=\textwidth]
    {images/cap6/GSE225845_knapsack_selected_contributions_stacked}
  \caption{Stacked objective contributions for the
           50 selected CpGs.}
\end{subfigure}
\caption{GSE225845: compressed panel diagnostics.}
...
\begin{subfigure}[b]{0.48\textwidth}
  \includegraphics[width=\textwidth]
    {images/cap6/GSE287331_ScoreDist}
  \caption{Score distribution — 5,000 CpGs.}
\end{subfigure}
\hfill
\begin{subfigure}[b]{0.48\textwidth}
  \includegraphics[width=\textwidth]
    {images/cap6/GSE287331_svmcheck_score_dist_50cpg}
  \caption{Score distribution — 50-CpG compressed model.}
\end{subfigure}
\caption{GSE287331: SVM decision score distributions for the
         full and compressed panels.}
...
\centering
\includegraphics[width=0.6\textwidth]
  {images/cap6/GSE287331_boundary_pca_prob_calibrated}
\caption{GSE287331: calibrated SVM decision boundary projected
         onto the first two principal components.}
...
\begin{subfigure}[b]{0.48\textwidth}
  \includegraphics[width=\textwidth]
    {images/cap6/GSE287331_volcano_50cpg}
  \caption{Volcano plot: SVM coefficient magnitude
           vs.\ $\Delta M$ effect size.}
\end{subfigure}
\hfill
\begin{subfigure}[b]{0.48\textwidth}
  \includegraphics[width=\textwidth]
    {images/cap6/GSE287331_knapsack_selected_contributions_stacked}
  \caption{Stacked objective contributions for the
           50 selected CpGs.}
\end{subfigure}
\caption{GSE287331: compressed panel diagnostics.}
...
\subsubsection*{Within-dataset biological signal}
...
\subsubsection*{Between-dataset batch effect}
...
\subsubsection*{Pairwise concordance metrics}
...
\begin{subfigure}[b]{0.31\textwidth}
  \includegraphics[width=\textwidth]
    {images/cap6/6x6_deltaM_scatter_GSE69914_vs_GSE225845}
  \caption{GSE69914 vs.\ GSE225845\\ ($\rho=0.08$, $c=0.76$).}
\end{subfigure}
\hfill
\begin{subfigure}[b]{0.31\textwidth}
  \includegraphics[width=\textwidth]
    {images/cap6/6x6_deltaM_scatter_GSE69914_vs_GSE287331}
  \caption{GSE69914 vs.\ GSE287331\\ ($\rho=0.49$, $c=0.50$).}
\end{subfigure}
\hfill
\begin{subfigure}[b]{0.31\textwidth}
  \includegraphics[width=\textwidth]
    {images/cap6/6x6_deltaM_scatter_GSE225845_vs_GSE287331}
...
\centering
\includegraphics[width=0.65\textwidth]
  {images/cap6/6x6_deltaM_direction_heatmap}
\caption{Heatmap of signed $\Delta M$ directions across the
         three cohorts on the shared CpG intersection,
         highlighting the polarity inversion of GSE287331
         relative to the other two datasets.}
\label{fig:deltam_heatmap}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.65\textwidth]
  {images/cap6/6x6_deltaM_violin}
