...
\begin{columns}[T]
  ...
  \begin{column}{0.48\textwidth}
    \centering
    \includegraphics[height=3.4cm]{images/impatto.png}
  ...
  \begin{column}{0.48\textwidth}
    \centering
    \includegraphics[height=3.4cm]{images/field_cancerisation.png}
...
\begin{columns}[T]
  ...
  \begin{column}{0.58\textwidth}
    \centering
    \includegraphics[width=\textwidth]{images/GSE225845_03_beta_density_random_samples.pdf}
    {\scriptsize \textit{Distribuzione media del $\beta$-value per classe — GSE225845}}
  \end{column}
  ...
  \begin{column}{0.38\textwidth}
    ...
    \textbf{Sito CpG:} dinucleotide citosina--guanina.\\
    La metilazione della citosina regola l'espressione genica.\\[8pt]
    
    \textbf{$\beta \in [0,1]$:} grado di metilazione per sito.\\[8pt]

    \textbf{Le curve si sovrappongono} $\rightarrow$ il problema è sottile.\\[12pt]

    \rule{\textwidth}{0.4pt}\\[6pt]

    {\small
    \textbf{Illumina EPIC:} $\sim$866k siti CpG\\[4pt]
    \begin{tabular}{lcc}
      & \textbf{Norm.} & \textbf{Adj.} \\
      GSE225845 & 113 & 140 \\
      GSE287331 & 182 & 60 \\
      \textbf{Tot.} & \textbf{295} & \textbf{200} \\
    \end{tabular}
    }
