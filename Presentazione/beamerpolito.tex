...
\centering
\includegraphics[width=\linewidth]{images/GSE225845_boundary_pca_prob_calibrated.pdf}
...
\begin{itemize}
  ...
  \item \textbf{Rilevanza:} ipometilazione del promotore tra i marcatori più consolidati di field cancerization mammaria
\end{itemize}
}
\end{beamercolorbox}
...
\begin{itemize}
  ...
  \item \textbf{Ruolo:} pathway Notch, mantenimento cellule staminali tumorali
...
\vspace{0.5em}
\centering
{\small Il pannello da 50 CpG dimostra che \textbf{performance e interpretabilità
...
Trasferibilità a EPIC v2 e HM450K da verificare.
}
...
Un CpG è rimosso se:
\[
\text{SD}_j < Q_{0.02}\!\left(\text{SD} \mid \mathcal{D}_{\text{train}}\right)
\]
...
\begin{itemize}\setlength\itemsep{0.3em}
  ...
  \item \textbf{Soglia data-driven} — bottom 2\% della distribuzione SD(M) sul train
