...
any study of epigenetic field effects, as discussed in Chapter~\ref{chap:data}.
...
cells must acquire to become malignant \cite{Hanahan2000,Hanahan2011}. These
...
hypomethylation and focal hypermethylation \cite{ehrlich2002}. This duality was
first described in the early 1980s and has since been confirmed across virtually
all tumor types, including breast cancer.

\textbf{Global hypomethylation} affects repetitive sequences (satellite DNA,
LINE-1 elements) and is thought to promote genomic instability through aberrant
activation of transposable elements and loss of imprinting. It also results in
transcriptional derepression at genes that are normally silenced \cite{ehrlich2002}.

\textbf{Focal hypermethylation}, by contrast, targets CpG islands at the promoters
...
equivalent to mutation but is potentially reversible, making it an attractive
therapeutic target.

Critically, neither of these phenomena is random. Genes susceptible to
hypermethylation in cancer are systematically enriched for targets of the Polycomb
Repressive Complex 2 (PRC2) and display bivalent chromatin states in embryonic
stem cells — a configuration that marks developmental genes as both transcriptionally
poised and repressed \cite{Teschendorff2010_stemcell}. This connection between
developmental regulation and cancer-associated silencing suggests that
epigenetic alterations in malignancy partially recapitulate stem cell programs.
...
cancerization}. Originally proposed by Slaughter in 1953 on the basis of
histopathological observations in oral cancer, the field effect hypothesis
posits that carcinogenesis does not occur in isolation but rather within
a ``conditioned'' tissue field that has been broadly reprogrammed by molecular
alterations preceding frank malignancy.

In breast cancer, epigenetic field defects have been systematically characterized
using genome-wide methylation profiling. A foundational contribution by
Teschendorff et al.\ demonstrated that histologically normal breast tissue adjacent
to tumors harbors a specific pattern of methylation alterations distinct from both
distant normal tissue and from tumor tissue itself \cite{Teschendorff2016}. These
alterations are not random: they are enriched at PRC2 target genes, CTCF-binding
regions, and loci involved in developmental pathways including WNT and FGF
signaling — precisely the categories implicated in the aging-cancer methylation axis
described above.

Crucially, the field defect signature identified by Teschendorff et al.\ was
detectable not through classical differential mean analysis, but through
\textit{differential variability} — a statistically distinct framework that
quantifies the increase in methylation dispersion across samples rather than
directional shifts in average levels \cite{Teschendorff2016,Teschendorff2014}.
This distinction has important methodological implications. Under a classical
framework, loci with increased variance but small mean differences are invisible
to standard hypothesis tests. Detecting them requires variance-sensitive statistics,
such as the Levene test or its robust variants. The biological interpretation is
that field defects reflect a partial and heterogeneous epigenetic reprogramming:
not all cells in the adjacent tissue are affected equally, and the stochastic
nature of the alteration is reflected as increased dispersion across individuals
rather than as a uniform shift.

The progressive nature of epigenetic field formation is further supported by
the observation that hypervariable loci in adjacent tissue tend to become
hypermethylated in the matched invasive tumor, suggesting a deterministic
convergence from a heterogeneous pre-malignant landscape to a consolidated
malignant epigenetic state \cite{Teschendorff2016}:
\[
\text{Normal} \rightarrow
\text{Epigenetically reprogrammed adjacent tissue} \rightarrow
\text{Invasive carcinoma}.
\]
This progressive model implies that the adjacent tissue is not merely
``contaminated'' by the adjacent tumor but rather represents an earlier stage
on the same carcinogenic trajectory. Detecting this intermediate stage — and
characterizing its methylation signature — is therefore of both biological
and clinical significance.

% -------------------------------------------------------
\section{Differential Variability as a Statistical Paradigm}
% -------------------------------------------------------
...
selective pressures operating across a population of cells. The biological evidence
reviewed in this chapter converges on a model in which this progression is both
measurable and partially predictable from methylation data alone.

Normal breast tissue accumulates methylation variability with age at a specific
set of loci — those associated with Polycomb regulation and bivalent chromatin.
This drift creates a heterogeneous epigenetic landscape from which pre-malignant
field defects emerge. Adjacent tissue, histologically indistinguishable from normal,
harbors a measurable epigenetic signature of this reprogramming — detectable
predominantly as increased variability rather than as a directional shift in mean
methylation. As carcinogenesis proceeds, this heterogeneous pre-malignant state
converges toward a more consolidated malignant configuration characterized by
focal hypermethylation at tumor-suppressive loci and global hypomethylation
elsewhere.
...
as a continuous biological spectrum rather than a set of discrete categories: the
adjacent tissue occupies a genuinely intermediate epigenetic state, distinct from
both normal and tumor, and warrants explicit characterization rather than
collapsing into either extreme. Second, any feature selection strategy operating
on this axis must be sensitive to variance differences and not only to mean shifts:
field defects are by definition heterogeneous signals that may not survive
standard mean-based filtering. Third, cross-cohort reproducibility is a necessary
validation criterion: signatures that replicate across independent datasets are
more likely to reflect genuine biological structure than cohort-specific noise.
...
comparative characterization of the three independent breast tissue methylation
cohorts introduced in Chapter~\ref{sec:data_preparation_exploration}.