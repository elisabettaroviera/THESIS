...
\begin{columns}[T]
  ...
  \begin{column}{0.48\textwidth}
    ...
    \begin{itemize}
      \item[\textbf{--}] \textbf{Alterazioni epigenetiche precoci}
      \item[\textbf{--}] \textbf{Distinguere} Normale da Adiacente ha 
    \end{itemize}
  \end{column}
...
\begin{tikzpicture}[
  ...
  n0style/.style={base, draw=purple!60!black, fill=purple!20},
  n1style/.style={base, draw=violet!50, fill=violet!12},
  filterstyle/.style={base, draw=red!40, fill=red!8},
  hlstyle/.style={base, font=\small\bfseries, thick,
    draw=azzurroborder, fill=azzurro},
