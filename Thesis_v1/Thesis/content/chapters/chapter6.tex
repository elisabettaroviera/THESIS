...
The AUC decreases modestly ($0.9565 \to 0.9363$) while MCC remains high
...
confirm that both panel versions achieve confident class separation around
$f(x) = 0$.
...
continuum of progressive epigenetic drift, with discriminative capacity
scaling toward full malignant transformation.
...
The remaining COSMIC-annotated loci --- \textit{BRCA2} (cg24674189, hyper),
\textit{FBLN2} (cg08198486, hypo), \textit{AKT1} (cg15957959, hypo), and
...
signal. The PC1 diagnostics of
Section~\ref{sec:pc1_diagnostic} show that batch variance
