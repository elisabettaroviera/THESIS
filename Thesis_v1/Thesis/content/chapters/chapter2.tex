...
increase lifetime risk \cite{brca_factsheet}. BRCA-associated tumors tend to be
...
repressed \cite{Teschendorff2010}, suggesting that epigenetic alterations
...
in cancer \cite{Teschendorff2010}.
...
% -------------------------------------------------------
\section{Field Cancerisation: The Concept and Its Epigenetic Basis}
% -------------------------------------------------------

A central concept motivating the present thesis is that of \textit{field
cancerisation}. Originally proposed by Slaughter in 1953 from histopathological
...
tissue \cite{Teschendorff2016fielddefects}, enriched at PRC2 target genes, CTCF-binding
...
rather than directional shifts in average levels \cite{Teschendorff2016fielddefects,Teschendorff2014}.
...
CpGs identified by mean-based tests alone \cite{Teschendorff2016fielddefects}.
